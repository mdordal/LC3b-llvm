//===-- FPMover.cpp - LC3b double-precision floating point move fixer ----===//
//
...
namespace {
  struct FPMover : public MachineFunctionPass {
    ...
    virtual const char *getPassName() const {
      return "LC3b Double-FP Move Fixer";
    }
...
/// createLC3bFPMoverPass - Returns a pass that turns FpMOVD
/// instructions into FMOVS instructions
///
FunctionPass *llvm::createLC3bFPMoverPass(TargetMachine &tm) {
