//===-- DelaySlotFiller.cpp - LC3B delay slot filler ---------------------===//
//
...
static cl::opt<bool> DisableDelaySlotFiller(
  "disable-lc3b-delay-filler",
  cl::init(false),
  cl::desc("Disable the LC3b delay slot filler."),
  cl::Hidden);
...
/// createLC3bDelaySlotFillerPass - Returns a pass that fills in delay
/// slots in LC3b MachineFunctions
///
FunctionPass *llvm::createLC3bDelaySlotFillerPass(TargetMachine &tm) {
